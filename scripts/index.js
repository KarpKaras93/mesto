...
const placeName = document.querySelector('.popup-add__input_type_place');
const placeLink = document.querySelector('.popup-add__input_type_link');
...
function closePopup() {
  ...
  popapElement.classList.remove('popup_opened');
};
